...
export function createStatusBar(context: vscode.ExtensionContext): StatusBar {
  ...
  context.subscriptions.push(
    ...
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (disposed) return; // Guard against use-after-disposal
      if (

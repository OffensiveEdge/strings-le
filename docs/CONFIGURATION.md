...
| `string-le.notificationsLevel`               | enum    | `"silent"` | Notification verbosity: `all`, `important`, or `silent`.                                      |
| `string-le.showParseErrors`                  | boolean | `false`    | Show parse errors as VS Code notifications when parsing fails.                                |
| `string-le.dedupeEnabled`                    | boolean | `false`    | Enable automatic deduplication of extracted strings.                                          |
